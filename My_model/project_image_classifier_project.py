...
Original file is located at
    https://colab.research.google.com/drive/1M6VT9Peg4SnChAeyg4u2Bytt1KFrRFne
...
# %pip install tensorflow-gpu==2.2.0rc4
...
print('\t\u2022 tf.databas version:', tfds.__version__)
...
dataset, dataset_info = tfds.load('oxford_flowers102', split=['train[:60%]', 'train[60%:80%]', 'train[80%:]'], data_dir='~/tensorflow_datasets', with_info=True, as_supervised=True,download=False)
...
plt.imshow(image)
plt.suptitle(class_names[str(label)], fontsize=20)
# plt.colorbar()
plt.show()
...
save_best = tf.keras.callbacks.ModelCheckpoint(filepath='/content/best_model.h5', monitor='val_loss', save_best_only=True)
...
saved_keras_model = './model{}.h5'.format(int(t))
...
image_path = '/content/orange_dahlia.jpg'
...
<img src='/content/orange_dahlia.jpg' width=600px>
